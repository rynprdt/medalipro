...
//Get Data Kabupaten
	...
	// curl_setopt_array($curl, array(
	  ...
	  // CURLOPT_HTTPHEADER => array(
	    // "key: 98e9d36cc27027ac700eedb860ebdce5"
	  // ),
	// ));
	...
	// curl_close($curl);
	 ...
	 echo "<label>Yogyakarta</label><br>";
	...
	$(document).ready(function(){
		$('#provinsi').change(function(){
			...
			var prov = $('#provinsi').val();
      		...
      		$.ajax({
            	type : 'GET',
           		url : 'http://localhost/jogjakainbatik/cek_kabupaten.php',
            	data :  'prov_id=' + prov,
		...
		$("#cek").click(function(){
			...
			var berat = $('#berat').val();
      		...
      		$.ajax({
            	type : 'POST',
           		url : 'http://localhost/jogjakainbatik/cek_ongkir.php',
