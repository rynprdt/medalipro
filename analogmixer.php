...
<head>
	...
	<meta name="description" content="Website, Corporate, Pacitan, Pro, Audio, Shop"/>
	<meta name="keywords" content="Sound System, Recording, Analog Mixer" />
	<!-- end: Meta -->
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Analog Mixer</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='Analog Mixer' order by kode DESC");
			...
			<div class="row">
				...
				<div class="span2">
					<div id="footer-menu-logo">
						<a href="#"><img src="../img/cat.png" alt="logo" /></a>
					</div>
				</div>
				...
				<div class="span9">
					...
					<div id="footer-menu-links">
						...
						<ul id="footer-nav">
							...
							<li><a href="#">Analog Mixer</a></li>

							<li><a href="#">Digital Mixer</a></li>
