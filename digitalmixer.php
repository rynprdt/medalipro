...
<head>
	...
	<meta name="description" content="Website, Corporate, Pacitan, Pro, Audio,"/>
	<meta name="keywords" content="Sound System, Recording, Digital Mixer " />
	<!-- end: Meta -->
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Digital Mixer</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='Digital Mixer' order by kode DESC");
