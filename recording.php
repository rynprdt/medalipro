...
<head>
	...
	<meta name="keywords" content="Toko Sound System, Recording, Mixer Analog, Mixer Digital, Recording," />
	<!-- end: Meta -->
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Recording</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='Recording' order by kode DESC");
